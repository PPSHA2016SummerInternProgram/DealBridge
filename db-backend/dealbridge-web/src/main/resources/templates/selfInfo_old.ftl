...
<html>
  ...
  <span style="text-shadow:1px 1px 1px blue;position:absolute;left:173px;">个人信息</span>
  </div>
 	<div class="xian"></div>
...
<br>
  ...
  <div class="cuxian"></div>
    ...
    <br>
 	<div class="bank"><img src="/img/招商银行.png" class="img"><p style="padding-top:5px;position:absolute;left:50px">招商银行</p><p style="padding-top:20px;position:absolute;left:50px;font-size:12px">信用卡</p>
    <p style="padding-top:40px;padding-left:-50px;position:absolute;left:100px;font-size:20px">**** **** **** 6975</p></div>
 <br>
 <div class="bank"><img src="/img/建设银行.png" class="img"><p style="padding-top:5px;position:absolute;left:50px">建设银行</p><p style="padding-top:20px;position:absolute;left:50px;font-size:12px">信用卡</p>
 <p style="padding-top:40px;padding-left:-50px;position:absolute;left:100px;font-size:20px">**** **** **** 9995</p></div>
<br>
